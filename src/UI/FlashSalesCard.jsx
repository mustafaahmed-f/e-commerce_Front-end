function FlashSalesCard({ cardNum }) {
  return (
    <div className="flex flex-col min-w-48 sm:px-5 px-2 py-2 shadow-[0px_0px_2px_3px_#F3F3F3]  rounded-md cursor-pointer flashSalesCard">
      ...
      <div className="py-2 text-center ">
        <img
          ...
          src={`../../public/photo bag ${cardNum}.png`}
        />
      </div>
